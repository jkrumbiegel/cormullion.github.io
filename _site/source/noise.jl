...
# ![image label](IMAGEFOLDER/graph-random.png)
...
# ![image label](IMAGEFOLDER/graph-0-200.png)
...
# ![image label](IMAGEFOLDER/graph-0-10.png){: .center-image}
...
# ![image label](IMAGEFOLDER/graph-5.png){: .center-image}
...
# ![image label](IMAGEFOLDER/graph-0-1.png){: .center-image}
...
# ![image label](IMAGEFOLDER/graph-0-05.png){: .center-image}
...
# ![image label](IMAGEFOLDER/colorbars.svg){: .center-image}
...
# ![image label](IMAGEFOLDER/pebbles.png){: .center-image}
...
# ![image label](IMAGEFOLDER/detail-graph.svg){: .center-image}
...
# ![image label](IMAGEFOLDER/persistence-graph.svg){: .center-image}
...
# ![image label](IMAGEFOLDER/treerings.svg){: .center-image}
...
# ![image label](IMAGEFOLDER/text-setting.png){: .center-image}
...
# ![image label](IMAGEFOLDER/jabberwocky.png){: .center-image}
...
# ![image label](IMAGEFOLDER/tron-800.png){: .center-image}
...
# ![image label](IMAGEFOLDER/table.svg){: .center-image}
...
# ![image label](IMAGEFOLDER/imstillfree.gif){: .center-image}
...
# ![image label](IMAGEFOLDER/isograph.svg){: .center-image}
...
# ![image label](IMAGEFOLDER/joydivision.jpg){: .center-image}
...
# ![image label](IMAGEFOLDER/isosurface-2.png){: .center-image}
...
# ![image label](IMAGEFOLDER/isosolid.png){: .center-image}
...
# ![image label](IMAGEFOLDER/landscape-leonardo.png){: .center-image}

landscape(ColorSchemes.starrynight, "images/noise/landscapes-starrynight")

#-

# ![image label](IMAGEFOLDER/landscapes-starrynight.png){: .center-image}
...
IMAGEFOLDER = "images/noise"                                                   #src

Literate.notebook("source/noise.jl", "notebooks", preprocess = setimagefolder) #src

# for Markdown/Jekyll notebook, put images in "/images"                        #src

IMAGEFOLDER = "/images/noise"                                                  #src

Literate.markdown("source/noise.jl", ".", name="_posts/2018-10-11-noise",      #src
