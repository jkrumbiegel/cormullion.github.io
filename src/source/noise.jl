...
# ![image label](IMAGEFOLDER/graph-0-10.png)
...
# ![image label](IMAGEFOLDER/graph-5.png)
...
# ![image label](IMAGEFOLDER/graph-0-1.png)
...
# ![image label](IMAGEFOLDER/graph-0-05.png)
...
# ![image label](IMAGEFOLDER/colorbars.svg)
...
# ![image label](IMAGEFOLDER/pebbles.png)
...
# ![image label](IMAGEFOLDER/detail-graph.svg)
...
# ![image label](IMAGEFOLDER/persistence-graph.svg)
...
# ![image label](IMAGEFOLDER/treerings.svg)
...
# ![image label](IMAGEFOLDER/text-setting.png)
...
# ![image label](IMAGEFOLDER/jabberwocky.png)
...
# ![image label](IMAGEFOLDER/tron-800.png)
...
# ![image label](IMAGEFOLDER/table.svg)
...
# ![image label](IMAGEFOLDER/imstillfree.gif)
...
# ![image label](IMAGEFOLDER/isograph.svg)
...
# ![image label](IMAGEFOLDER/joydivision.jpg)
...
# ![image label](IMAGEFOLDER/isosurface-2.png)
...
# ![image label](IMAGEFOLDER/isosolid.png)
...
# ![image label](IMAGEFOLDER/landscape-leonardo.png)

landscape(ColorSchemes.starrynight, "../images/noise/landscapes-starrynight")

#-

# ![image label](IMAGEFOLDER/landscapes-starrynight.png)
